...
<div class="w3-top">
	<div class="w3-bar w3-white w3-wide w3-padding w3-card-2">
		...
		<ul class="nav navbar-nav" >
			...
			<li class="active"><a id="demo"></a></li>
		</ul>
		...
		<ul class="nav navbar-nav navbar-right">
			<c:url var="logoutUrl" value="/cikis" />
			<sf:form action="${logoutUrl}" method="post">
				<button type="submit" class="btn btn-danger" value="Logout"><span class="glyphicon glyphicon-log-out"></span> Log out</button>
